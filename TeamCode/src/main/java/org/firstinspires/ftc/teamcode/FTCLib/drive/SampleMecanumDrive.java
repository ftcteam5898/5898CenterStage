package org.firstinspires.ftc.teamcode.FTCLib.drive;
...
public class SampleMecanumDrive extends MecanumDrive {
    public static PIDCoefficients TRANSLATIONAL_PID = new PIDCoefficients(4.75, 0, 0.000000000005);
    public static PIDCoefficients HEADING_PID = new PIDCoefficients(3.5, 0, 0);

    public static double LATERAL_MULTIPLIER = 1.15657079691;
